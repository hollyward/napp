...
var ClientConnectionManager = /** @class */ (function (_super) {
    ...
    ClientConnectionManager.prototype.getOrConnect = function (address, ownerConnection) {
        ...
        this.triggerConnect(address).then(function (socket) {
            var clientConnection = new ClientConnection_1.ClientConnection(_this.client, address, socket);
    ...
    ClientConnectionManager.prototype.triggerConnect = function (address) {
        var _this = this;
