...
var SerializationServiceV1 = /** @class */ (function () {
    ...
    SerializationServiceV1.prototype.toData = function (object, partitioningStrategy) {
        ...
        var dataOutput = new ObjectData_1.PositionalObjectDataOutput(1, this, this.serializationConfig.isBigEndian);
    ...
    SerializationServiceV1.prototype.registerIdentifiedFactories = function () {
        ...
        for (var id_1 in factoryConfigs) {
            var path = factoryConfigs[id_1].path;
            var exportedName = factoryConfigs[id_1].exportedName;
            var factoryConstructor = Util.loadNameFromPath(path, exportedName);
            factories[id_1] = new factoryConstructor();
        }
